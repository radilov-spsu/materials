...
- **NFR-01.** Платформа: .NET (актуальная LTS), ASP.NET Core, PostgreSQL.
...
- **NFR-09.** Спецификация OpenAPI генерируется из кода и доступна по `/swagger/v1/swagger.json`.
- **NFR-10.** Идентификаторы сущностей — GUID, монотонно возрастающие по времени создания.
