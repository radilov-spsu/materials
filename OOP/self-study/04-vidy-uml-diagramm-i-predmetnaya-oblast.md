...
> `/docs/architecture/*.md` — типичное место в рабочем проекте. В работах курса
> кладите диаграмму в папку своей работы, рядом с кодом: правило то же самое —
> текст рядом с тем, что он описывает.
