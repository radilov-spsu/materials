...
|---|------|-----|--------------|
| 1 | Что общего у паттернов поведения | 4 | 0:04 |
| 2 | Strategy и Template Method | 8 | 0:12 |
| 3 | Observer (наблюдатель) | 7 | 0:19 |
| 4 | Command (команда) | 7 | 0:26 |
| 5 | State (состояние) | 6 | 0:32 |
| 6 | Chain of Responsibility (цепочка обязанностей) | 6 | 0:38 |
| 7 | Iterator (итератор) | 5 | 0:43 |
| 8 | Mediator (посредник) | 5 | 0:48 |
| 9 | Memento (хранитель) | 5 | 0:53 |
| 10 | Visitor (посетитель) | 7 | 1:00 |

---

## Блок 1. Что общего у паттернов поведения (4 мин)
...
## Блок 2. Strategy и Template Method (8 мин)
...
## Блок 3. Observer — наблюдатель (7 мин)
...
## Блок 6. Chain of Responsibility — цепочка обязанностей (6 мин)
...
## Блок 7. Iterator — итератор (5 мин)
...
## Блок 8. Mediator — посредник (5 мин)
...
## Блок 9. Memento — хранитель (5 мин)
...
## Блок 10. Visitor — посетитель (7 мин)
